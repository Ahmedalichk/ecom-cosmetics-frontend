...
export default function ProductCard({ id, img, name, price, sale }: IProduct) {
      ...
      <div className="relative">
        ...
        >
          <div className="absolute bottom-0 mb-4 left-[50%] translate-x-[-50%] flex gap-2">
            <div className="bgwhite w-[50px] h-[50px] text-[26px] grid place-items-center">
              <AiOutlineHeart />
            </div>
            <div
              className="bgwhite w-[50px] h-[50px] text-[26px] grid place-items-center"
